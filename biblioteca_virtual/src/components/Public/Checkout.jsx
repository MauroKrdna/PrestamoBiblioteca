            ...
            <div className="card-body">
              <div className="order-summary mb-4">
                ...
                <div className="d-flex justify-content-between align-items-center mb-2">
                  <span>Subtotal:</span>
                  <span className="fw-bold" id="subtotal">$0</span>
                </div>
                <div className="d-flex justify-content-between align-items-center mb-2">
                  <span>Domicilio:</span>
                  <span className="fw-bold" id="shipping">$5.000</span>
                </div>
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <span>Descuento:</span>
                  <span className="fw-bold text-danger" id="discount">-$0</span>
                </div>
                <div className="d-flex justify-content-between align-items-center border-top pt-3 mb-4">
                  <h5 className="mb-0">Total:</h5>
                  <h5 className="mb-0 text-primary" id="total">$0</h5>
                </div>
              </div>
